...
var root$2 = /* @__PURE__ */ template(`<div><div class="st-panel svelte-p402yk"></div></div>`);
const $$css$3 = {
  hash: "svelte-p402yk",
  code: '@media (max-width: 62rem) {.scrollyteller--mobile-row-variant .st-panel.svelte-p402yk::before {opacity:0 !important;}.scrollyteller--mobile-row-variant .st-panel-root.svelte-p402yk {margin:40vh auto;}\n}.st-panel-root.svelte-p402yk {--panel-radius: 0.75rem;--panel-background: var(--color-panel-background, rgba(255, 255, 255, 0.95));--panel-color: var(--color-panel-text, #000);--panel-opacity: var(--color-panel-opacity, 1);--panel-filter: var(--color-panel-filter, blur(2.5px));--panel-border: var(--color-panel-border, 1px solid rgba(0, 0, 0, 0.15));--panel-padding: 1rem;\n  /* How opaque do we make inactive panels on 2 column mode */--panel-opacity-inactive: var(--color-panel-opacity-inactive, 1);\n  /** How much margin should we have between panels on 2 column mode */--panel-column-margin: var(--color-panel-margin, 40vh);box-sizing:border-box;margin:80vh auto;position:relative;z-index:1;pointer-events:none;}\n@media (min-width: 46.5rem) {.st-panel-root.svelte-p402yk {--panel-padding: 2rem;}\n}[data-scheme="dark"] .st-panel-root.svelte-p402yk, .is-dark-mode .st-panel-root.svelte-p402yk {--panel-background: var(--color-panel-background, rgba(15, 15, 15, 0.95));--panel-color: var(--color-panel-text, #ebebeb);--panel-border: var(--color-panel-border, 1px solid rgba(255, 255, 255, 0.15));}.scrollyteller--debug .st-panel-root.svelte-p402yk {outline:5px solid limegreen;}.st-panel-root.first.svelte-p402yk {margin-top:100dvh;}.st-panel-root.last.svelte-p402yk {margin-bottom:50vh;}\n@media (min-width: 62rem) {.st-panel-root--left.svelte-p402yk, .st-panel-root--right.svelte-p402yk {margin-top:var(--panel-column-margin);margin-bottom:var(--panel-column-margin);opacity:1;}.st-panel-root--left.st-panel-root--transparent-blocks.st-panel-root--active.svelte-p402yk, .st-panel-root--right.st-panel-root--transparent-blocks.st-panel-root--active.svelte-p402yk {opacity:1;}.st-panel-root--left.st-panel-root--transparent-blocks.svelte-p402yk, .st-panel-root--right.st-panel-root--transparent-blocks.svelte-p402yk {--panel-filter: none;--panel-background: none;--panel-border: none;--panel-padding: 0;opacity:var(--panel-opacity-inactive);}.st-panel-root--left.first.svelte-p402yk, .st-panel-root--right.first.svelte-p402yk {margin-top:50dvh;}\n}.st-panel.svelte-p402yk {-webkit-backdrop-filter:var(--panel-filter);backdrop-filter:var(--panel-filter);color:var(--panel-color);border-radius:var(--panel-radius);padding:var(--panel-padding);}.st-panel.svelte-p402yk::before {content:"";background-color:var(--panel-background);opacity:var(--panel-opacity);border-radius:var(--panel-radius);border:var(--panel-border);position:absolute;z-index:-1;top:0;left:0;width:100%;height:100%;}.st-panel.svelte-p402yk::after {content:"";display:table;clear:both;}.st-panel.svelte-p402yk > * {pointer-events:all;color:var(--panel-color);margin-top:0;margin-left:auto !important;margin-right:auto !important;}.st-panel.svelte-p402yk > *:last-child {margin-bottom:0;}.st-panel.svelte-p402yk > :is(div, p) {font-family:ABCSans, sans-serif;font-size:inherit;line-height:1.666666667;}.st-panel.svelte-p402yk > img {max-width:66%;display:block;margin:auto;height:auto;}.st-panel.svelte-p402yk > :is(h1, h2, h3, h4) {font-family:var(--od-font-stack-serif);}'
};
function Panel($$anchor, $$props) {
  ...
  template_effect(() => {
    ...
    classes = set_class(div, 1, `st-panel-root ${panelClass() || ""}`, "svelte-p402yk", classes, {
