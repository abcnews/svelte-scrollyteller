  ...
  legacy_pre_effect(
    ...
    () => {
      if ($isMobileRowMode()) {
        ...
        set(rootMargin, `-${threshold}% 0px -30% 0px`);
...
var root$2 = /* @__PURE__ */ template(`<div><div class="st-panel svelte-usod2i"></div></div>`);
const $$css$3 = {
  hash: "svelte-usod2i",
  code: '@media (max-width: 62rem) {.scrollyteller--mobile-row-variant .st-panel.svelte-usod2i::before {opacity:0 !important;}.scrollyteller--mobile-row-variant .st-panel-root.svelte-usod2i {margin:40vh auto;}\n}.st-panel-root.svelte-usod2i {--panel-radius: 0.75rem;--panel-background: var(--color-panel-background, rgba(255, 255, 255, 0.95));--panel-color: var(--color-panel-text, #000);--panel-opacity: var(--color-panel-opacity, 1);--panel-filter: var(--color-panel-filter, blur(2.5px));--panel-border: var(--color-panel-border, 1px solid rgba(0, 0, 0, 0.15));--panel-padding: 1rem;\n  /* How opaque do we make inactive panels on 2 column mode */--panel-opacity-inactive: var(--color-panel-opacity-inactive, 1);\n  /** How much margin should we have between panels on 2 column mode */--panel-column-margin: var(--color-panel-margin, 40vh);box-sizing:border-box;margin:80vh auto;position:relative;z-index:1;pointer-events:none;}\n@media (min-width: 46.5rem) {.st-panel-root.svelte-usod2i {--panel-padding: 2rem;}\n}[data-scheme="dark"] .st-panel-root.svelte-usod2i, .is-dark-mode .st-panel-root.svelte-usod2i {--panel-background: var(--color-panel-background, rgba(15, 15, 15, 0.95));--panel-color: var(--color-panel-text, #ebebeb);--panel-border: var(--color-panel-border, 1px solid rgba(255, 255, 255, 0.15));}.scrollyteller--debug .st-panel-root.svelte-usod2i {outline:5px solid limegreen;}.st-panel-root.first.svelte-usod2i {margin-top:100dvh;}.st-panel-root.last.svelte-usod2i {margin-bottom:50vh;}\n@media (min-width: 62rem) {.st-panel-root--left.svelte-usod2i, .st-panel-root--right.svelte-usod2i {margin-top:var(--panel-column-margin);margin-bottom:var(--panel-column-margin);opacity:1;}.st-panel-root--left.st-panel-root--transparent-blocks.st-panel-root--active.svelte-usod2i, .st-panel-root--right.st-panel-root--transparent-blocks.st-panel-root--active.svelte-usod2i {opacity:1;}.st-panel-root--left.st-panel-root--transparent-blocks.svelte-usod2i, .st-panel-root--right.st-panel-root--transparent-blocks.svelte-usod2i {--panel-filter: none;--panel-background: none;--panel-border: none;--panel-padding: 0;opacity:var(--panel-opacity-inactive);}.st-panel-root--left.first.svelte-usod2i, .st-panel-root--right.first.svelte-usod2i {margin-top:50dvh;}\n}.st-panel.svelte-usod2i {-webkit-backdrop-filter:var(--panel-filter);backdrop-filter:var(--panel-filter);color:var(--panel-color);border-radius:var(--panel-radius);padding:var(--panel-padding);max-width:640px;margin:auto;}.st-panel.svelte-usod2i::before {content:"";background-color:var(--panel-background);opacity:var(--panel-opacity);border-radius:var(--panel-radius);border:var(--panel-border);position:absolute;z-index:-1;top:0;left:0;width:100%;height:100%;}.st-panel.svelte-usod2i::after {content:"";display:table;clear:both;}.st-panel.svelte-usod2i > * {pointer-events:all;color:var(--panel-color);margin-top:0;margin-left:auto !important;margin-right:auto !important;}.st-panel.svelte-usod2i > *:last-child {margin-bottom:0;}.st-panel.svelte-usod2i > :is(div, p) {font-family:ABCSans, sans-serif;font-size:inherit;line-height:1.666666667;}.st-panel.svelte-usod2i > img {max-width:66%;display:block;margin:auto;height:auto;}.st-panel.svelte-usod2i > :is(h1, h2, h3, h4) {font-family:var(--od-font-stack-serif);}'
};
function Panel($$anchor, $$props) {
  ...
  template_effect(() => {
    ...
    classes = set_class(div, 1, `st-panel-root ${panelClass() || ""}`, "svelte-usod2i", classes, {
...
function Panels($$anchor, $$props) {
  ...
  each(node, 1, () => get$1(panelGroups), index, ($$anchor2, group) => {
    ...
    template_effect(() => classes = set_class(div_1, 1, "content svelte-1qnkhkx", null, classes, {
...
const $$css$1 = {
  hash: "svelte-7x6m8q",
  code: ".scrollyteller--mobile-row-variant {--marginOuter: 0;--vizMarginOuter: 0;}\n@media (max-width: 62rem) {.scrollyteller--mobile-row-variant .viz--resized.svelte-7x6m8q {z-index:10;top:0;margin:0;background:white;width:100% !important;max-height:calc(45vh + 50px);aspect-ratio:1;container-type:normal;padding-bottom:40px;background:linear-gradient(to bottom, white 90%, transparent 100%);}\n}.viz.svelte-7x6m8q {transform:translate3d(0, 0, 0);height:100dvh;position:sticky;top:0;left:0;z-index:1;}.viz--resized.svelte-7x6m8q {container-type:size;height:60dvh;top:10dvh;display:flex;justify-content:center;align-items:flex-start;margin:0 auto;margin:0 auto;width:calc(100% - var(--marginOuter) * 2);max-width:calc(100vw - var(--vizMarginOuter) * 2);}\n@media (min-width: 46.5rem) {.viz--resized.svelte-7x6m8q {--margin: 4rem;top:8dvh;height:62dvh;}\n}.viz--resized.viz--left.svelte-7x6m8q, .viz--resized.viz--right.svelte-7x6m8q {width:var(--rightColumnWidth);}\n@media (min-width: 62rem) {.viz--resized.viz--left.svelte-7x6m8q, .viz--resized.viz--right.svelte-7x6m8q {align-items:center;height:84dvh;top:8dvh;}\n}\n@media (min-width: 75rem) {.viz--resized.viz--left.svelte-7x6m8q, .viz--resized.viz--right.svelte-7x6m8q {height:76dvh;top:12dvh;}\n}\n@media (min-width: 90rem) {.viz--resized.viz--left.svelte-7x6m8q, .viz--resized.viz--right.svelte-7x6m8q {top:10dvh;height:80dvh;}\n}\n@media (min-width: 62rem) {.viz--resized.viz--left.svelte-7x6m8q {margin:0 auto 0 0;}\n}\n@media (min-width: 62rem) {.viz--resized.viz--right.svelte-7x6m8q {margin:0 0 0 auto;}\n}\n@media (min-width: 62rem) {.viz--resized.viz--centre.svelte-7x6m8q {top:8dvh;height:62dvh;}\n}\n@media (min-width: 75rem) {.viz--resized.viz--centre.svelte-7x6m8q {top:12dvh;height:58dvh;}\n}\n@media (min-width: 90rem) {.viz--resized.viz--centre.svelte-7x6m8q {top:12dvh;height:58dvh;}\n}.scrollyteller--debug .viz--resized.svelte-7x6m8q {outline:5px solid limegreen;}"
};
function Viz($$anchor, $$props) {
  ...
  template_effect(() => classes = set_class(div, 1, "viz svelte-7x6m8q", null, classes, {
