...
const maxScrollytellerWidth = derived(
  [isSplitScreen],
...
class ScreenDimsStoreUpdater extends SvelteComponent {
  constructor(options) {
    super();
    init(this, options, instance$6, create_fragment$5, safe_not_equal, { align: 2 });
  }
  get align() {
    return this.$$.ctx[2];
  }
...
function add_css$3(target) {
  append_styles(target, "svelte-7aiz7h", '.st-panel-root.svelte-7aiz7h{--panel-radius:0.75rem;--panel-background:var(--color-panel-background, rgba(255, 255, 255, 0.95));--panel-color:var(--color-panel-text, #000);--panel-opacity:var(--color-panel-opacity, 1);--panel-filter:var(--color-panel-filter, blur(2.5px));--panel-border:var(--color-panel-border, 1px solid rgba(0, 0, 0, 0.15));--panel-padding:1rem;box-sizing:border-box;margin:80vh auto;position:relative;z-index:1;pointer-events:none}@media(min-width: 46.5rem){.st-panel-root.svelte-7aiz7h{--panel-padding:2rem}}[data-scheme="dark"] .st-panel-root.svelte-7aiz7h,.is-dark-mode .st-panel-root.svelte-7aiz7h{--panel-background:var(--color-panel-background, rgba(15, 15, 15, 0.95));--panel-color:var(--color-panel-text, #ebebeb);--panel-border:var(--color-panel-border, 1px solid rgba(255, 255, 255, 0.15))}.scrollyteller--debug .st-panel-root.svelte-7aiz7h{outline:5px solid limegreen}.st-panel-root.first.svelte-7aiz7h{margin-top:100dvh}.st-panel-root.last.svelte-7aiz7h{margin-bottom:100vh}@media(min-width: 62rem){.st-panel-root--left.svelte-7aiz7h,.st-panel-root--right.svelte-7aiz7h{margin-top:40vh;margin-bottom:40vh}.st-panel-root--left.st-panel-root--transparent-blocks.svelte-7aiz7h,.st-panel-root--right.st-panel-root--transparent-blocks.svelte-7aiz7h{--panel-filter:none;--panel-background:none;--panel-border:none;--panel-padding:0}.st-panel-root--left.first.svelte-7aiz7h,.st-panel-root--right.first.svelte-7aiz7h{margin-top:50dvh}}.st-panel.svelte-7aiz7h{-webkit-backdrop-filter:var(--panel-filter);backdrop-filter:var(--panel-filter);color:var(--panel-color);border-radius:var(--panel-radius);padding:var(--panel-padding)}.st-panel.svelte-7aiz7h::before{content:"";background-color:var(--panel-background);opacity:var(--panel-opacity);border-radius:var(--panel-radius);border:var(--panel-border);position:absolute;z-index:-1;top:0;left:0;width:100%;height:100%}.st-panel.svelte-7aiz7h::after{content:"";display:table;clear:both}.st-panel.svelte-7aiz7h > *{pointer-events:all;color:var(--panel-color);margin-top:0;margin-left:auto !important;margin-right:auto !important}.st-panel.svelte-7aiz7h > *:last-child{margin-bottom:0}.st-panel.svelte-7aiz7h > :is(div, p){font-family:ABCSans, sans-serif;font-size:inherit;line-height:1.666666667}.st-panel.svelte-7aiz7h>img{max-width:66%;display:block;margin:auto;height:auto}.st-panel.svelte-7aiz7h > :is(h1, h2, h3, h4){font-family:var(--od-font-stack-serif)}');
}
function create_fragment$4(ctx) {
  ...
  return {
    c() {
      div1 = element("div");
      div0 = element("div");
      attr(div0, "class", "st-panel svelte-7aiz7h");
      attr(
        div1,
        "data-align",
        /*align*/
...
class Panel extends SvelteComponent {
  constructor(options) {
    super();
    init(this, options, instance$5, create_fragment$4, safe_not_equal, { props: 5 }, add_css$3);
  }
  get props() {
    return this.$$.ctx[5];
  }
...
class GraphicObserver extends SvelteComponent {
  constructor(options) {
    super();
    init(this, options, instance$3, null, safe_not_equal, { graphicRootEl: 0 });
  }
  get graphicRootEl() {
    return this.$$.ctx[0];
  }
