...
class OnProgressHandler extends SvelteComponent {
  constructor(options) {
    super();
    init(this, options, instance$9, create_fragment$7, safe_not_equal, { scrollytellerRef: 1 });
  }
...
class DeprecationNotice extends SvelteComponent {
  constructor(options) {
    super();
    init(this, options, instance$8, null, safe_not_equal, { onProgress: 0, onMarker: 1 });
  }
  get onProgress() {
    return this.$$.ctx[0];
  }
...
function create_if_block$4(ctx) {
  ...
  return {
    c() {
      ...
      set_style(div, "height", innerHeight - /*rootMargin*/
      ctx[2] * 2 + "px");
    },
    m(target, anchor) {
...
function instance$7($$self, $$props, $$invalidate) {
  ...
  $$self.$$set = ($$props2) => {
    if ("marker" in $$props2) $$invalidate(8, marker = $$props2.marker);
    ...
    if ("vizMarkerThreshold" in $$props2) $$invalidate(9, vizMarkerThreshold = $$props2.vizMarkerThreshold);
  };
  $$self.$$.update = () => {
    ...
    5) {
      {
        if (observerOptions) {
          $$invalidate(10, _observerOptions = observerOptions);
        } else {
          $$invalidate(10, _observerOptions = {
          ...
          $$invalidate(11, panelObserver = new IntersectionObserver(
            (entries) => {
              entries.forEach((entry) => {
                ...
                if (newPanel) {
                  $$invalidate(8, marker = newPanel.target.scrollyData);
                  set_store_value(currentPanel, $currentPanel = $steps.findIndex((step) => step === newPanel.target), $currentPanel);
                }
              });
            },
            _observerOptions
...
function instance$6($$self, $$props, $$invalidate) {
  ...
  component_subscribe($$self, globalAlign, (value) => $$invalidate(6, $globalAlign = value));
  const screenDims = getContext("screenDims");
  component_subscribe($$self, screenDims, (value) => $$invalidate(7, $screenDims = value));
  let { align = "centre" } = $$props;
  let innerWidth = 0;
  let innerHeight2 = 0;
  function onwindowresize() {
    $$invalidate(0, innerWidth = window.innerWidth);
    $$invalidate(1, innerHeight2 = window.innerHeight);
  }
  $$self.$$set = ($$props2) => {
    if ("align" in $$props2) $$invalidate(4, align = $$props2.align);
  };
  $$self.$$.update = () => {
    if ($$self.$$.dirty & /*innerWidth, innerHeight*/
    3) {
      set_store_value(screenDims, $screenDims = [innerWidth, innerHeight2], $screenDims);
    }
    if ($$self.$$.dirty & /*align*/
    16) {
      set_store_value(globalAlign, $globalAlign = align, $globalAlign);
    }
  };
  return [innerWidth, innerHeight2, globalAlign, screenDims, align, onwindowresize];
}
class ScreenDimsStoreUpdater extends SvelteComponent {
  constructor(options) {
    super();
    init(this, options, instance$6, create_fragment$5, safe_not_equal, { align: 4 });
  }
  get align() {
    return this.$$.ctx[4];
  }
...
function add_css$3(target) {
  append_styles(target, "svelte-pv2kpf", '.st-panel-root.svelte-pv2kpf{--panel-radius:0.75rem;--panel-background:var(--color-panel-background, rgba(255, 255, 255, 0.95));--panel-color:var(--color-panel-text, #000);--panel-opacity:var(--color-panel-opacity, 1);--panel-filter:var(--color-panel-filter, blur(2.5px));--panel-border:var(--color-panel-border, 1px solid rgba(0, 0, 0, 0.15));--panel-padding:1rem;--panel-opacity-inactive:var(--color-panel-opacity-inactive, 1);--panel-column-margin:var(--color-panel-margin, 40vh);box-sizing:border-box;margin:80vh auto;position:relative;z-index:1;pointer-events:none}@media(min-width: 46.5rem){.st-panel-root.svelte-pv2kpf{--panel-padding:2rem}}[data-scheme="dark"] .st-panel-root.svelte-pv2kpf,.is-dark-mode .st-panel-root.svelte-pv2kpf{--panel-background:var(--color-panel-background, rgba(15, 15, 15, 0.95));--panel-color:var(--color-panel-text, #ebebeb);--panel-border:var(--color-panel-border, 1px solid rgba(255, 255, 255, 0.15))}.scrollyteller--debug .st-panel-root.svelte-pv2kpf{outline:5px solid limegreen}.st-panel-root.first.svelte-pv2kpf{margin-top:100dvh}.st-panel-root.last.svelte-pv2kpf{margin-bottom:50vh}@media(min-width: 62rem){.st-panel-root--left.svelte-pv2kpf,.st-panel-root--right.svelte-pv2kpf{margin-top:var(--panel-column-margin);margin-bottom:var(--panel-column-margin);opacity:1}.st-panel-root--left.st-panel-root--transparent-blocks.st-panel-root--active.svelte-pv2kpf,.st-panel-root--right.st-panel-root--transparent-blocks.st-panel-root--active.svelte-pv2kpf{opacity:1}.st-panel-root--left.st-panel-root--transparent-blocks.svelte-pv2kpf,.st-panel-root--right.st-panel-root--transparent-blocks.svelte-pv2kpf{--panel-filter:none;--panel-background:none;--panel-border:none;--panel-padding:0;opacity:var(--panel-opacity-inactive)}.st-panel-root--left.first.svelte-pv2kpf,.st-panel-root--right.first.svelte-pv2kpf{margin-top:50dvh}}.st-panel.svelte-pv2kpf{-webkit-backdrop-filter:var(--panel-filter);backdrop-filter:var(--panel-filter);color:var(--panel-color);border-radius:var(--panel-radius);padding:var(--panel-padding)}.st-panel.svelte-pv2kpf::before{content:"";background-color:var(--panel-background);opacity:var(--panel-opacity);border-radius:var(--panel-radius);border:var(--panel-border);position:absolute;z-index:-1;top:0;left:0;width:100%;height:100%}.st-panel.svelte-pv2kpf::after{content:"";display:table;clear:both}.st-panel.svelte-pv2kpf > *{pointer-events:all;color:var(--panel-color);margin-top:0;margin-left:auto !important;margin-right:auto !important}.st-panel.svelte-pv2kpf > *:last-child{margin-bottom:0}.st-panel.svelte-pv2kpf > :is(div, p){font-family:ABCSans, sans-serif;font-size:inherit;line-height:1.666666667}.st-panel.svelte-pv2kpf>img{max-width:66%;display:block;margin:auto;height:auto}.st-panel.svelte-pv2kpf > :is(h1, h2, h3, h4){font-family:var(--od-font-stack-serif)}');
}
function create_fragment$4(ctx) {
  ...
  return {
    c() {
      div1 = element("div");
      div0 = element("div");
      attr(div0, "class", "st-panel svelte-pv2kpf");
      attr(
        div1,
        "data-align",
        /*align*/
    ...
    m(target, anchor) {
      ...
      ctx[10](div1);
      if (!mounted) {
        dispose = action_destroyer(children_action = children.call(
          null,
          div0,
          /*nodes*/
          ctx[3]
    ...
    p(ctx2, [dirty]) {
      if (children_action && is_function(children_action.update) && dirty & /*nodes*/
      8) children_action.update.call(
        null,
        /*nodes*/
        ctx2[3]
      );
      ...
      if (dirty & /*panelClass, transparentFloat*/
      6) {
        toggle_class(
          div1,
          "st-panel-root--transparent-blocks",
...
function instance$5($$self, $$props, $$invalidate) {
  ...
  $$self.$$set = ($$props2) => {
    if ("align" in $$props2) $$invalidate(0, align = $$props2.align);
    if ("transparentFloat" in $$props2) $$invalidate(1, transparentFloat = $$props2.transparentFloat);
    if ("panelClass" in $$props2) $$invalidate(2, panelClass = $$props2.panelClass);
...
class Panel extends SvelteComponent {
  ...
  set transparentFloat(transparentFloat) {
    this.$$set({ transparentFloat });
    flush();
  }
  get panelClass() {
    return this.$$.ctx[2];
...
create_custom_element(Panel, { "align": {}, "transparentFloat": {}, "panelClass": {}, "data": {}, "nodes": {}, "i": {} }, [], [], true);
function add_css$2(target) {
  append_styles(target, "svelte-1qnkhkx", ".content.svelte-1qnkhkx{margin:-100dvh auto 0;padding-bottom:1px;position:relative;z-index:2;pointer-events:none;font-size:1.125rem}@media(min-width: 62rem){.content--centre.svelte-1qnkhkx{max-width:48.75rem}}@media(min-width: 90rem){.content--centre.svelte-1qnkhkx{max-width:56.25rem}}.content--left.svelte-1qnkhkx,.content--right.svelte-1qnkhkx{max-width:127.5rem;margin-left:0}@media(min-width: 62rem){.content--left.svelte-1qnkhkx,.content--right.svelte-1qnkhkx{max-width:40rem;margin-right:calc(var(--rightColumnWidth, 100px) + var(--marginOuter) * 1);font-size:1.125rem}}@media(min-width: 75rem){.content--left.svelte-1qnkhkx,.content--right.svelte-1qnkhkx{font-size:1.125rem}}@media(min-width: 90rem){.content--left.svelte-1qnkhkx,.content--right.svelte-1qnkhkx{max-width:45rem;font-size:1.25rem}}.content--right.svelte-1qnkhkx{margin-right:0;margin-left:calc(var(--rightColumnWidth, 100px) + var(--marginOuter) * 1)}");
}
...
function create_else_block(ctx) {
  ...
  let panel_1_props = {};
  for (let i = 0; i < panel_1_spread_levels.length; i += 1) {
    panel_1_props = assign(panel_1_props, panel_1_spread_levels[i]);
  }
  panel_1 = new Panel({ props: panel_1_props });
  return {
    c() {
    ...
    p(ctx2, dirty) {
      const panel_1_changes = dirty & /*panelGroups, layout, steps*/
      13 ? get_spread_update(panel_1_spread_levels, [
        dirty & /*panelGroups*/
        8 && get_spread_object(
          /*panel*/
          ctx2[8]
        ),
        dirty & /*panelGroups, layout*/
        9 && {
          align: (
            /*panel*/
            ctx2[8].align || /*layout*/
...
function create_each_block(ctx) {
  ...
  return {
    c() {
      ...
      t = space();
      attr(div, "class", "content svelte-1qnkhkx");
      toggle_class(
        div,
        "content--centre",
        /*group*/
...
function instance$4($$self, $$props, $$invalidate) {
  ...
  $$self.$$set = ($$props2) => {
    ...
    if ("steps" in $$props2) $$invalidate(2, steps = $$props2.steps);
  };
  $$self.$$.update = () => {
  ...
  return [layout, customPanel, steps, panelGroups, panels];
}
...
function add_css$1(target) {
  append_styles(target, "svelte-1uvy8v3", ".viz.svelte-1uvy8v3{transform:translate3d(0, 0, 0);height:100dvh;position:sticky;top:0;left:0;z-index:1}.viz--resized.svelte-1uvy8v3{container-type:size;height:60dvh;top:10dvh;display:flex;justify-content:center;align-items:flex-start;margin:0 auto;margin:0 auto;width:calc(100% - var(--marginOuter) * 2);max-width:calc(100vw - var(--vizMarginOuter) * 2)}@media(min-width: 46.5rem){.viz--resized.svelte-1uvy8v3{--margin:4rem;top:8dvh;height:62dvh}}.viz--resized.viz--left.svelte-1uvy8v3,.viz--resized.viz--right.svelte-1uvy8v3{width:var(--rightColumnWidth)}@media(min-width: 62rem){.viz--resized.viz--left.svelte-1uvy8v3,.viz--resized.viz--right.svelte-1uvy8v3{align-items:center;height:84dvh;top:8dvh}}@media(min-width: 75rem){.viz--resized.viz--left.svelte-1uvy8v3,.viz--resized.viz--right.svelte-1uvy8v3{height:76dvh;top:12dvh}}@media(min-width: 90rem){.viz--resized.viz--left.svelte-1uvy8v3,.viz--resized.viz--right.svelte-1uvy8v3{top:10dvh;height:80dvh}}@media(min-width: 62rem){.viz--resized.viz--left.svelte-1uvy8v3{margin:0 auto 0 0}}@media(min-width: 62rem){.viz--resized.viz--right.svelte-1uvy8v3{margin:0 0 0 auto}}@media(min-width: 62rem){.viz--resized.viz--centre.svelte-1uvy8v3{top:8dvh;height:62dvh}}@media(min-width: 75rem){.viz--resized.viz--centre.svelte-1uvy8v3{top:12dvh;height:58dvh}}@media(min-width: 90rem){.viz--resized.viz--centre.svelte-1uvy8v3{top:12dvh;height:58dvh}}.scrollyteller--debug .viz--resized.svelte-1uvy8v3{outline:5px solid limegreen}");
}
...
function create_fragment$2(ctx) {
  ...
  let if_block = (
    /*isInViewport*/
    (ctx[2] || /*discardSlot*/
    ctx[1] === false) && create_if_block$2(ctx)
  );
  return {
    c() {
      ...
      div = element("div");
      if (if_block) if_block.c();
      attr(div, "class", "viz svelte-1uvy8v3");
      toggle_class(
        div,
        "viz--resized",
        /*layout*/
        ctx[0].resizeInteractive
      );
      toggle_class(
        div,
        "viz--right",
        /*layout*/
        ctx[0].resizeInteractive && /*layout*/
        ctx[0].align === "left"
      );
      toggle_class(
        div,
    ...
    p(ctx2, [dirty]) {
      ...
      if (dirty & /*graphicRootEl*/
      8) graphicobserver_changes.graphicRootEl = /*graphicRootEl*/
      ctx2[3];
      ...
      if (
        ...
        if (if_block) {
          if_block.p(ctx2, dirty);
          if (dirty & /*isInViewport, discardSlot*/
          6) {
            transition_in(if_block, 1);
          }
        } else {
      ...
      1) {
        toggle_class(
          ...
          "viz--right",
          /*layout*/
          ctx2[0].resizeInteractive && /*layout*/
          ctx2[0].align === "left"
        );
      }
      if (!current || dirty & /*layout*/
...
function instance$2($$self, $$props, $$invalidate) {
  ...
  let { isInViewport = false } = $$props;
  const dispatch = createEventDispatcher();
  let graphicRootEl;
  function div_binding($$value) {
    binding_callbacks[$$value ? "unshift" : "push"](() => {
      graphicRootEl = $$value;
      $$invalidate(3, graphicRootEl);
    });
  }
  $$self.$$set = ($$props2) => {
    if ("layout" in $$props2) $$invalidate(0, layout = $$props2.layout);
    if ("discardSlot" in $$props2) $$invalidate(1, discardSlot = $$props2.discardSlot);
    if ("isInViewport" in $$props2) $$invalidate(2, isInViewport = $$props2.isInViewport);
  ...
  return [layout, discardSlot, isInViewport, graphicRootEl, $$scope, slots, div_binding];
}
class Viz extends SvelteComponent {
  constructor(options) {
    super();
    init(
      this,
  ...
  set isInViewport(isInViewport) {
    this.$$set({ isInViewport });
    flush();
  }
}
...
function create_fragment$1(ctx) {
  ...
  return {
    c() {
      ...
      t1 = space();
      create_component(screendimsstoreupdater.$$.fragment);
      t2 = space();
    ...
    m(target, anchor) {
      ...
      mount_component(screendimsstoreupdater, target, anchor);
    ...
    p(ctx2, dirty) {
      ...
      1) panels_1_changes.customPanel = /*customPanel*/
      ctx2[0];
      ...
      if (dirty[0] & /*$maxScrollytellerWidthStore*/
      4096) {
        set_style(
          div0,
          "--maxScrollytellerWidthPx",
      ...
      if (dirty[0] & /*$maxGraphicWidthStore*/
      8192) {
        set_style(div0, "--rightColumnWidth", `min(calc(var(--maxScrollytellerWidth) * var(--vizMaxWidth)), ${/*$maxGraphicWidthStore*/
        ctx2[13]}px)`);
      }
    ...
    i(local) {
      ...
      transition_in(screendimsstoreupdater.$$.fragment, local);
      transition_in(panelobserver.$$.fragment, local);
      transition_in(if_block2);
      transition_in(if_block3);
      transition_in(panels_1.$$.fragment, local);
      current = true;
    },
    o(local) {
      transition_out(if_block0);
      transition_out(deprecationnotice.$$.fragment, local);
      transition_out(screendimsstoreupdater.$$.fragment, local);
      transition_out(panelobserver.$$.fragment, local);
      transition_out(if_block2);
      transition_out(if_block3);
      transition_out(panels_1.$$.fragment, local);
      current = false;
    },
    d(detaching) {
      if (detaching) {
      ...
      destroy_component(screendimsstoreupdater, detaching);
...
function instance$1($$self, $$props, $$invalidate) {
  ...
  let isDebug;
  let $ratioStore;
  let $maxScrollytellerWidthStore;
  let $maxGraphicWidthStore;
  let { $$slots: slots = {}, $$scope } = $$props;
  const dispatch = createEventDispatcher();
  ...
  component_subscribe($$self, ratioStore, (value) => $$invalidate(31, $ratioStore = value));
  ...
  component_subscribe($$self, maxScrollytellerWidthStore, (value) => $$invalidate(12, $maxScrollytellerWidthStore = value));
  ...
  component_subscribe($$self, maxGraphicWidthStore, (value) => $$invalidate(13, $maxGraphicWidthStore = value));
  ...
  $$self.$$set = ($$props2) => {
    ...
    if ("layout" in $$props2) $$invalidate(18, layout = $$props2.layout);
    if ("ratio" in $$props2) $$invalidate(19, ratio = $$props2.ratio);
  ...
  $$self.$$.update = () => {
    ...
    524288) {
      set_store_value(ratioStore, $ratioStore = ratio, $ratioStore);
    }
