...
const $$css$1 = {
  hash: "svelte-x54kdo",
  code: ".scrollyteller--mobile-row-variant {--marginOuter: 0;--vizMarginOuter: 0;}\n@media (max-width: 62rem) {.scrollyteller--mobile-row-variant .viz--resized.svelte-x54kdo {z-index:10;top:0;background:white;margin:0;\n    /* height: 40dvh; */height:inherit;}\n}.viz.svelte-x54kdo {transform:translate3d(0, 0, 0);height:100dvh;position:sticky;top:0;left:0;z-index:1;}.viz--resized.svelte-x54kdo {container-type:size;height:60dvh;top:10dvh;display:flex;justify-content:center;align-items:flex-start;margin:0 auto;margin:0 auto;width:calc(100% - var(--marginOuter) * 2);max-width:calc(100vw - var(--vizMarginOuter) * 2);}\n@media (min-width: 46.5rem) {.viz--resized.svelte-x54kdo {--margin: 4rem;top:8dvh;height:62dvh;}\n}.viz--resized.viz--left.svelte-x54kdo, .viz--resized.viz--right.svelte-x54kdo {width:var(--rightColumnWidth);}\n@media (min-width: 62rem) {.viz--resized.viz--left.svelte-x54kdo, .viz--resized.viz--right.svelte-x54kdo {align-items:center;height:84dvh;top:8dvh;}\n}\n@media (min-width: 75rem) {.viz--resized.viz--left.svelte-x54kdo, .viz--resized.viz--right.svelte-x54kdo {height:76dvh;top:12dvh;}\n}\n@media (min-width: 90rem) {.viz--resized.viz--left.svelte-x54kdo, .viz--resized.viz--right.svelte-x54kdo {top:10dvh;height:80dvh;}\n}\n@media (min-width: 62rem) {.viz--resized.viz--left.svelte-x54kdo {margin:0 auto 0 0;}\n}\n@media (min-width: 62rem) {.viz--resized.viz--right.svelte-x54kdo {margin:0 0 0 auto;}\n}\n@media (min-width: 62rem) {.viz--resized.viz--centre.svelte-x54kdo {top:8dvh;height:62dvh;}\n}\n@media (min-width: 75rem) {.viz--resized.viz--centre.svelte-x54kdo {top:12dvh;height:58dvh;}\n}\n@media (min-width: 90rem) {.viz--resized.viz--centre.svelte-x54kdo {top:12dvh;height:58dvh;}\n}.scrollyteller--debug .viz--resized.svelte-x54kdo {outline:5px solid limegreen;}"
};
function Viz($$anchor, $$props) {
  ...
  template_effect(() => classes = set_class(div, 1, "viz svelte-x54kdo", null, classes, {
