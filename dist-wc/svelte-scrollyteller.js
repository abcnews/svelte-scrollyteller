...
var root$2 = /* @__PURE__ */ template(`<div><div class="st-panel svelte-fu64sm"></div></div>`);
const $$css$3 = {
  hash: "svelte-fu64sm",
  code: `/* Mobile row variant doesn't need scrims etc */
@media (max-width: 62rem) {.scrollyteller--mobile-row-variant .st-panel.svelte-fu64sm::before {opacity:0 !important;}
}.st-panel-root.svelte-fu64sm {--panel-radius: 0.75rem;--panel-background: var(--color-panel-background, rgba(255, 255, 255, 0.95));--panel-color: var(--color-panel-text, #000);--panel-opacity: var(--color-panel-opacity, 1);--panel-filter: var(--color-panel-filter, blur(2.5px));--panel-border: var(--color-panel-border, 1px solid rgba(0, 0, 0, 0.15));--panel-padding: 1rem;
...
@media (min-width: 46.5rem) {.st-panel-root.svelte-fu64sm {--panel-padding: 2rem;}
}[data-scheme="dark"] .st-panel-root.svelte-fu64sm, .is-dark-mode .st-panel-root.svelte-fu64sm {--panel-background: var(--color-panel-background, rgba(15, 15, 15, 0.95));--panel-color: var(--color-panel-text, #ebebeb);--panel-border: var(--color-panel-border, 1px solid rgba(255, 255, 255, 0.15));}.scrollyteller--debug .st-panel-root.svelte-fu64sm {outline:5px solid limegreen;}.st-panel-root.first.svelte-fu64sm {margin-top:100dvh;}.st-panel-root.last.svelte-fu64sm {margin-bottom:50vh;}
@media (min-width: 62rem) {.st-panel-root--left.svelte-fu64sm, .st-panel-root--right.svelte-fu64sm {margin-top:var(--panel-column-margin);margin-bottom:var(--panel-column-margin);opacity:1;}.st-panel-root--left.st-panel-root--transparent-blocks.st-panel-root--active.svelte-fu64sm, .st-panel-root--right.st-panel-root--transparent-blocks.st-panel-root--active.svelte-fu64sm {opacity:1;}.st-panel-root--left.st-panel-root--transparent-blocks.svelte-fu64sm, .st-panel-root--right.st-panel-root--transparent-blocks.svelte-fu64sm {--panel-filter: none;--panel-background: none;--panel-border: none;--panel-padding: 0;opacity:var(--panel-opacity-inactive);}.st-panel-root--left.first.svelte-fu64sm, .st-panel-root--right.first.svelte-fu64sm {margin-top:50dvh;}
}.st-panel.svelte-fu64sm {-webkit-backdrop-filter:var(--panel-filter);backdrop-filter:var(--panel-filter);color:var(--panel-color);border-radius:var(--panel-radius);padding:var(--panel-padding);}.st-panel.svelte-fu64sm::before {content:"";background-color:var(--panel-background);opacity:var(--panel-opacity);border-radius:var(--panel-radius);border:var(--panel-border);position:absolute;z-index:-1;top:0;left:0;width:100%;height:100%;}.st-panel.svelte-fu64sm::after {content:"";display:table;clear:both;}.st-panel.svelte-fu64sm > * {pointer-events:all;color:var(--panel-color);margin-top:0;margin-left:auto !important;margin-right:auto !important;}.st-panel.svelte-fu64sm > *:last-child {margin-bottom:0;}.st-panel.svelte-fu64sm > :is(div, p) {font-family:ABCSans, sans-serif;font-size:inherit;line-height:1.666666667;}.st-panel.svelte-fu64sm > img {max-width:66%;display:block;margin:auto;height:auto;}.st-panel.svelte-fu64sm > :is(h1, h2, h3, h4) {font-family:var(--od-font-stack-serif);}`
};
function Panel($$anchor, $$props) {
  ...
  template_effect(() => {
    ...
    classes = set_class(div, 1, `st-panel-root ${panelClass() || ""}`, "svelte-fu64sm", classes, {
...
const $$css$1 = {
  hash: "svelte-ke652w",
  code: ".scrollyteller--mobile-row-variant {--marginOuter: 0;--vizMarginOuter: 0;}\n@media (max-width: 62rem) {.scrollyteller--mobile-row-variant .viz--resized.svelte-ke652w {z-index:10;top:0;margin:0;background:white;width:100% !important;height:unset !important;aspect-ratio:1;container-type:normal;padding-bottom:40px;background:linear-gradient(to bottom, white 90%, transparent 100%);}\n}.viz.svelte-ke652w {transform:translate3d(0, 0, 0);height:100dvh;position:sticky;top:0;left:0;z-index:1;}.viz--resized.svelte-ke652w {container-type:size;height:60dvh;top:10dvh;display:flex;justify-content:center;align-items:flex-start;margin:0 auto;margin:0 auto;width:calc(100% - var(--marginOuter) * 2);max-width:calc(100vw - var(--vizMarginOuter) * 2);}\n@media (min-width: 46.5rem) {.viz--resized.svelte-ke652w {--margin: 4rem;top:8dvh;height:62dvh;}\n}.viz--resized.viz--left.svelte-ke652w, .viz--resized.viz--right.svelte-ke652w {width:var(--rightColumnWidth);}\n@media (min-width: 62rem) {.viz--resized.viz--left.svelte-ke652w, .viz--resized.viz--right.svelte-ke652w {align-items:center;height:84dvh;top:8dvh;}\n}\n@media (min-width: 75rem) {.viz--resized.viz--left.svelte-ke652w, .viz--resized.viz--right.svelte-ke652w {height:76dvh;top:12dvh;}\n}\n@media (min-width: 90rem) {.viz--resized.viz--left.svelte-ke652w, .viz--resized.viz--right.svelte-ke652w {top:10dvh;height:80dvh;}\n}\n@media (min-width: 62rem) {.viz--resized.viz--left.svelte-ke652w {margin:0 auto 0 0;}\n}\n@media (min-width: 62rem) {.viz--resized.viz--right.svelte-ke652w {margin:0 0 0 auto;}\n}\n@media (min-width: 62rem) {.viz--resized.viz--centre.svelte-ke652w {top:8dvh;height:62dvh;}\n}\n@media (min-width: 75rem) {.viz--resized.viz--centre.svelte-ke652w {top:12dvh;height:58dvh;}\n}\n@media (min-width: 90rem) {.viz--resized.viz--centre.svelte-ke652w {top:12dvh;height:58dvh;}\n}.scrollyteller--debug .viz--resized.svelte-ke652w {outline:5px solid limegreen;}"
};
function Viz($$anchor, $$props) {
  ...
  template_effect(() => classes = set_class(div, 1, "viz svelte-ke652w", null, classes, {
