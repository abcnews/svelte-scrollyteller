...
function add_css$1(target) {
  append_styles(target, "svelte-i12oyn", '.st-panel.svelte-i12oyn{--panel-radius:0.75rem;--panel-background:var(--color-panel-background, rgba(245, 245, 245, 0.95));--panel-color:var(--color-panel-text, #000);--panel-opacity:var(--color-panel-opacity, 1);--panel-filter:var(--color-panel-filter, blur(2.5px));--panel-border:var(--color-panel-border, none);-webkit-backdrop-filter:var(--panel-filter);backdrop-filter:var(--panel-filter);color:var(--panel-color);border-radius:var(--panel-radius);box-sizing:border-box;margin:80vh auto;width:calc(100% - 2rem);position:relative;z-index:1;pointer-events:none;font-size:18px;padding:1rem;max-width:660px}[data-scheme="dark"] .st-panel.svelte-i12oyn,.is-dark-mode .st-panel.svelte-i12oyn{--panel-background:var(--color-panel-background, rgba(15, 15, 15, 0.95));--panel-color:var(--color-panel-text, #ebebeb)}.scrollyteller--debug .st-panel.svelte-i12oyn{outline:5px solid limegreen}.st-panel.first.svelte-i12oyn{margin-top:50vh}.st-panel.last.svelte-i12oyn{margin-bottom:100vh}@media(min-width: 744px){.st-panel--centre.svelte-i12oyn{padding:2rem;max-width:720px}}@media(min-width: 992px){.st-panel--centre.svelte-i12oyn{padding:2rem;max-width:780px;font-size:20px}}@media(min-width: 1440px){.st-panel--centre.svelte-i12oyn{max-width:900px}}@media(min-width: 992px){.st-panel--left.svelte-i12oyn,.st-panel--right.svelte-i12oyn{--marginLeft:2rem;--marginRight:1rem;--maxWidth:45%;max-width:calc(var(--maxWidth) - (var(--marginLeft) + var(--marginRight)));margin:30vh 0 30vh calc(var(--marginLeft) - 1rem);font-size:18px}.st-panel--left.st-panel--transparent-blocks.svelte-i12oyn,.st-panel--right.st-panel--transparent-blocks.svelte-i12oyn{--panel-filter:none;--panel-background:none}}@media(min-width: 1200px){.st-panel--left.svelte-i12oyn,.st-panel--right.svelte-i12oyn{--marginLeft:3rem;--marginRight:1.5rem;--maxWidth:40%;font-size:18px}}@media(min-width: 1440px){.st-panel--left.svelte-i12oyn,.st-panel--right.svelte-i12oyn{--marginLeft:4rem;--marginRight:2rem;--maxWidth:40%;font-size:20px}}@media(min-width: 992px){.st-panel--right.svelte-i12oyn{margin:15vh calc(var(--marginLeft) - 1rem) 15vh auto}}.st-panel.svelte-i12oyn::before{content:"";background-color:var(--panel-background);opacity:var(--panel-opacity);border-radius:var(--panel-radius);border:var(--panel-border);position:absolute;z-index:-1;top:0;left:0;width:100%;height:100%}.st-panel.svelte-i12oyn::after{content:"";display:table;clear:both}.st-panel.svelte-i12oyn > *{font-family:ABCSans, sans-serif;font-size:inherit;line-height:1.666666667;color:var(--panel-color);margin-top:0;margin-left:auto !important;margin-right:auto !important;pointer-events:all}.st-panel.svelte-i12oyn > *:last-child{margin-bottom:0}.st-panel.svelte-i12oyn>img{max-width:66%;display:block;margin:auto;height:auto}');
}
