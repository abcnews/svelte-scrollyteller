...
### `npm link` into your Webpack Aunty project

1. run `npm link` in the svelte-scrollyteller repo
2. from your Aunty repo run `npm link @abcnews/svelte-scrollyteller`
3. Configure Aunty Webpack to transpile the linked repo by adding the _fully resolved path_ to your working directory. E.g. `"includedDependencies": ["/Users/ashk/Web/svelte-scrollyteller"]
