...
export declare function setIsSplitScreen([screenDims, globalAlign]: [
	any,
	any
]): import('svelte/store').Readable<boolean>;
export declare function setIsMobileRowMode([screenDims, mobileVariant]: [
	any,
	any
]): import('svelte/store').Readable<boolean>;
export declare function setMaxScrollytellerWidth([isSplitScreen]: [
	any
]): import('svelte/store').Readable<2040 | 1000000>;
export declare function setMaxGraphicWidth([
	isSplitScreen,
	graphicRootDims,
	screenDims,
	ratio,
	maxScrollytellerWidth
]: [any, any, any, any, any]): import('svelte/store').Readable<number>;
